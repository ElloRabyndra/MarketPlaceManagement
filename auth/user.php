...
<body class="font-[Poppins] <?= getColorClass('bg-gray-200 text-slate-900', 'bg-zinc-900 text-white') ?> flex flex-col md:items-center md:flex-row">
    ...
    <!-- Form Edit Profile -->
     <main class="flex-1 py-1 px-5 md:py-10 md:px-24 justify-center items-center">
            <h1 class="text-2xl font-bold mb-5">Edit Profile</h1>

            <?php if(isset($_SESSION['profile_success'])): ?>
             <div class="flex items-center gap-2 bg-green-400 px-4 py-2 rounded-lg mb-4">
            ...
            <?php if(isset($_SESSION['profile_error'])): ?>
             <div class="flex items-center gap-2 bg-red-400 px-4 py-2 rounded-lg mb-4">
            ...
            <form action="../include/authController.php" method="POST" class="space-y-4">
                ...
                <div class="w-full md:w-full flex flex-col gap-2">
                    <button type="submit" class="w-full py-2 px-4 bg-blue-500 rounded-xl hover:bg-blue-600 transition">Edit Profile</button>
                </div>
                </form>
     </main>
